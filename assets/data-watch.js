...
(function () {
  ...
  const COMPANIES = [
    ...
    {t:'SMR', n:'NuScale Power', cat:'Small Modular Reactors', corr:'industrial', col:'#facc15',
     thesis:'First NRC-certified SMR developer with first commercial customer signed',
     market:9.5, trajectory:5.0, edge:8.5, capital:5.5, asymmetry:9.0, valuation:5.0,
     revenue:0.031, growth:'N/A', gm:'N/A', tam:500,
     ev:2.7, evRev:87, evRevGrowth:'N/A', marginPath:'Pre-scale; profitability depends on Romania and US deployments converting backlog to recurring fleet revenue post-2033',
     confidence:'low',
     bull:'Only SMR developer with NRC-certified design — both 50 MWe original and uprated 77 MWe (second SMR design ever approved by the NRC). RoPower Romania final investment decision approved February 2026 for six modules (462 MW) at the Doicești coal-to-nuclear site — first commercial customer the SMR sector has produced. ~$841M cash provides 2–2.5 years runway. AI data center power demand structural; DOE loan momentum supportive.',
     bear:'Q1 2026 revenue $0.565M vs $14.7M consensus — catastrophic miss. 2025 revenue declined 15% YoY to $31.5M with $356M loss. First commercial module not in operation until 2033. Construction cost overruns endemic to nuclear; Carbon Free Power Project cancelled in 2023 over the same issue. Competition from OKLO, X-energy, BWXT, GE Hitachi BWRX-300.',
     body:'More mature than OKLO on the regulatory and customer dimensions — NRC-certified design, FID-approved Romanian project, ~$840M cash — but Q1 was a reminder that pre-fleet SMR developers run hot on narrative and cold on execution. The framework respects the regulatory moat (edge 8.5) and strategic position (market 9.5, asymmetry 9.0) while penalising trajectory (5.0) and valuation (5.0) for the Q1 miss and the 2033 commercial timeline. Sized as lottery ticket only — paired with OKLO this is a barbell on the SMR thesis: NuScale the regulatory-leader bet, OKLO the design-differentiation bet.'},
  ];
